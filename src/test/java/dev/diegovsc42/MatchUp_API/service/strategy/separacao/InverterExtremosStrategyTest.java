...
@SpringBootTest
class InverterExtremosStrategyTest {
    @Autowired
    private PartidaService partidaService;

    @Test
    @DisplayName("Deveria colocar os 3 jogadores do fim da equipe A no inicio da equipe B e os jogadores do inicio da equipe B no fim da equipe A")
    void test1() {
        //Arrange
        ...
        Partida partidaEsperada = new Partida(
                new Equipe(6, new ArrayList<>(List.of("Lucas", "Mariana", "João","Beatriz", "Felipe", "Larissa"))),
                new Equipe(6, new ArrayList<>(List.of("Ana", "Carlos", "Paulo","Gabriel", "Juliana", "Renato"))),
                new Equipe(3, new ArrayList<>(List.of("Rafael", "Camila", "Thiago")))
        );
        //Act
        Partida resultado = partidaService.separarEquipes(3, "EXTREMOS", partida);
